...
+ [API Structure](#api-structure)
  ...
  - [Entities](#entities)
    ...
    * [Campaign](#campaign)
    * [BuyOrder](#buyorder)
    * [Enum\<OrderStatus\>](#enumorderstatus)
    * [OrderQuery](#orderquery)
    * [MatchQuery](#matchquery)
    * [CampaignSummaryDTO](#campaignsummarydto)
    * [Instrument](#instrument)
    * [MatchInfoDTO](#matchinfodto)
    * [Deal](#deal)
  - [Endpoints](#endpoints)
    * [Market Availability Query](#market-availability-query)
    * [Market Query](#market-query)
    * [Attribute Query](#attribute-query)
    * [Campaign Creation](#campaign-creation)
    * [Buy Order Creation](#buy-order-creation)
    * [Buy Order Submission](#buy-order-submission)
    * [Buy Order Query](#buy-order-query)
    * [Buy Order Deactivation](#buy-order-deactivation)
    * [Match Query](#match-query)
    * [Match Summary](#match-summary)
    * [Advertiser Query](#advertiser-query)
    * [Advertiser Log Query](#advertiser-log-query)
+ [Workflow](#workflow)
+ [Examples](#examples)
  - [Querying the market](#querying-the-market)
  - [Creating a Campaign](#creating-a-campaign)
  - [Creating a BuyOrder](#creating-a-buyorder)
  - [Submitting a BuyOrder](#submitting-a-buyorder)
  - [Deactivating a BuyOrder](#deactivating-a-buyorder)
